...
| 6   |   Transformers I  | [Attention is all you need](https://papers.nips.cc/paper/7181-attention-is-all-you-need.pdf)   |[[slides](lectures/Lecture-6_Transformer_MT_2021.pdf)];  Recordings: [Transformer 1](https://www.youtube.com/watch?v=IoXR8z-nfYI)  [[video](xx)]; ```pwd:``` | | |
| 7   |   Transformers II  |     | [[video](https://ubc.zoom.us/rec/share/cqGh7Q223Iws99QrdAg_STVjnYXJXuwwdhagwixSIqWs7Kn8uFfLhRLRaCas0Yel.zs8m62dW99kw2TcJ)]; ```pwd:``` A!nQyn8w; [Transformer 2](https://www.youtube.com/watch?v=4Z5gkkCptHI) | ```Transformer``` [[Notebook](tutorials/week4/transformer_tutorial.ipynb)]; [[video](https://youtu.be/bByGuEwWJug)] | | 
