...
| 7   |   Transformers II  |     | [[video](xxx)]; ```pwd:``` ; [Transformer 2](https://www.youtube.com/watch?v=4Z5gkkCptHI) | ```Transformer``` [[Notebook](tutorials/week4/transformer_tutorial.ipynb)]; [[video](https://youtu.be/bByGuEwWJug)] | | 
